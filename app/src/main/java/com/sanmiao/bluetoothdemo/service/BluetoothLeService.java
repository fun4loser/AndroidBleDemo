...
import com.sanmiao.bluetoothdemo.utils.SampleGattAttributes;
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                String str = "";
                if(gatt.getDevice().getName().equals("001")){
                    str = "7e000200292713557f";//关闭1
                }else{
                    str = "7e010200292713557f";//关闭2
                }

                final byte[] tx = Utils.hexStringToBytes(str);
//                String aa = bytesToHexString(tx);
    ...
    public static void sendCmd(String cmd) {
        final byte[] tx = Utils.hexStringToBytes(cmd);
...
//        PublicStaticData.startTime = System.currentTimeMillis();
